...
namespace game
{
    ...
    Board StateInitializeGame::createBoard()
    {
        constexpr unsigned int kMinAxisSize = 2;
        constexpr unsigned int kMaxAxisSize = 50;
        unsigned int heightValue = getValidatedIntFromRange("> Board Height: ", kMinAxisSize, kMaxAxisSize);
        unsigned int widthValue = getValidatedIntFromRange("> Board Width: ", kMinAxisSize, kMaxAxisSize);
        
        Board::TileMatrix mMatrix{heightValue, std::vector<Tile>(widthValue)};
        ...
        return Board{mMatrix, BoardDimensions{widthValue, heightValue}};
    }

    unsigned int StateInitializeGame::getMinesPerPlayer()
    {
    ...
    unsigned int StateInitializeGame::getValidatedIntFromRange(std::string const& inputMsg, unsigned int min, unsigned int max)
    {
    ...
    std::vector<game::Player> StateInitializeGame::createPlayers(unsigned int minesPerPlayer)
    {
